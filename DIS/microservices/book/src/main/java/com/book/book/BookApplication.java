...
public class  BookApplication {
	...
	public void initIndicesAfterStartup() {
		...
		ReactiveIndexOperations indexOps = mongoTemplate.indexOps(BookEntity.class);
		resolver.resolveIndexFor(BookEntity.class).forEach(e -> indexOps.ensureIndex(e).block());
	}
